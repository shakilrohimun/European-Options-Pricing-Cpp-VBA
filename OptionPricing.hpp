...
// TU NE DOIS PAS GERER LES PROBLEMES DE VARIABLES SUR C++ MAIS SUR VBA DIRECTEMENT
// IL MANQUE LA VERSION CORRIGER DE LA VOLATILITE LOCAL
...
public:
    ...
    double localVolCallPrice(double spot, double strike, double rate, double maturity, size_t time_step, size_t pos_step);
